...
def main(args):
    ...
    if args.dataset == "mnist":
        ...
        real_dataset = CelebA(
            path="/rds/projects/c/chenhp-dm-mia/Diff-MIA-Attack/Data/processed/32_Train",
            transform=ToTensor(),
        )
        img_ch = 3
        num_classes = 10
        ...
        from src.data import CelebA
        real_dataset = CelebA(
            path="/rds/projects/c/chenhp-dm-mia/Diff-MIA-Attack/Data/processed/64_Train",
            transform=ToTensor(),
        )
        img_ch = 3
        num_classes = 10
    ...
    if args.dataset not in ["mnist", "fmnist","celeba", "celeba64"]:
        raise NotImplementedError
